...
INSERT INTO `Tb1User` VALUES ('p102', '김춘추', '010-1234-1001', 23, '부산시 금정구');
...
INSERT INTO `Tb1User` (`userId`, `userName`, `userHp`, `userAge`) VALUES ('p105', '이순신', '010-1234-1005', 50);

INSERT INTO `Tb1Product` VALUES (1, '냉장고', 800, 10, 'LG', '2022-01-06');
INSERT INTO `Tb1Product` VALUES (2, '노트북', 1200, 20, 'LG', '2022-01-06');
INSERT INTO `Tb1Product` VALUES (3, 'TV', 1400, 6, 'LG', '2022-01-06');
INSERT INTO `Tb1Product` VALUES (4, '세탁기', 1000, 8, 'LG', '2022-01-06');
INSERT INTO `Tb1Product` (`prdCode`, `prdName`, `prdPrice`, `prdAmount`) VALUES (5, '컴퓨터', 1100, 0);
INSERT INTO `Tb1Product` VALUES (6, '휴대폰', 900, 102, 'LG', '2022-01-06');
